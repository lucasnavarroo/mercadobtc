package com.example.exchanges_presentation.details
...
import com.example.exchanges_presentation.components.ExchangeCardHeader
import com.example.exchanges_presentation.components.ExchangeTextInfo
    ...
    Column(
        ...
        Column(
            modifier = Modifier
                ...
                .testTag("exchange_details_screen")
        ) {
            ...
            ExchangeTextInfo(
                ...
                value = "US$${exchangeItem.volumeOneHrsUsd}"
            )
            Spacer(modifier = Modifier.height(spacing.spaceLarge))
            ExchangeTextInfo(
                modifier = Modifier.fillMaxWidth(),
                title = stringResource(R.string.volume_one_day),
                value = "US$${exchangeItem.volumeOneDayUsd}"
            )
            Spacer(modifier = Modifier.height(spacing.spaceLarge))
            ExchangeTextInfo(
                modifier = Modifier.fillMaxWidth(),
                title = stringResource(R.string.volume_one_month),
                value = "US$${exchangeItem.volumeOneMthUsd}",
            )
        }
    }
}